...
7. **finishing-a-development-branch** - Activates when tasks complete. Verifies tests, presents options (merge/PR/keep/discard), cleans up branch.
...
- **using-feature-branches** - Feature branch workflow
